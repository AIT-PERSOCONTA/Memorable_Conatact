    ...
    <section className="relative pt-20 pb-16 px-0 flex flex-col items-center justify-center text-center overflow-hidden min-h-[90vh] md:pt-48 md:pb-32 md:px-6">
      <div className="responsive-container z-20 flex flex-col items-center flex-mobile-center">
        ...
        <h1 className="text-fluid-h1 font-black tracking-tighter leading-[1] md:leading-[0.9] mb-8 md:mb-10 text-center">
          <span className="gradient-text">Asokumar IT (AIT) Presents</span>
          <br />
          <span className="gradient-text">Memorable Contact (AES)</span>
        </h1>
        ...
        <p className={`text-base md:text-lg max-w-3xl mx-auto mb-10 md:mb-14 leading-relaxed font-medium transition-colors duration-300 text-center ${theme === 'dark' ? 'text-slate-400' : 'text-slate-600'}`}>
          <strong>Memorable Contact (AES)</strong> is the world-class AI network assistant by <strong>Asokumar IT (AIT)</strong>. <br className="hidden md:block" />
          Capture context via Chatbot, search via intent, and recall every professional detail instantly.
        </p>
